...
- `sentence_context` contains stable neighboring source subtitles for understanding only. It can cross request-batch boundaries; never translate, return, merge, or alter those neighbor items
